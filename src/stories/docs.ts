  ...
  classesDocs: [
    {
      ...
      comments: {
        summary: 'Authentication manager for QorusToolkit, allows to create and manage multiple\nQorusEndpoints',
      ...
      properties: [
        ...
        { name: 'endpoints', comments: { summary: null }, type: 'Endpoint[ ]' },
        { name: 'noauth', comments: { summary: null }, type: 'boolean' },
        {
    ...
    },
    {
      ...
      properties: [
        { name: 'context', comments: { summary: null }, type: 'Context' },
        { name: 'path', comments: { summary: null }, type: 'string[ ]' },
        { name: 'providerData', comments: { summary: null }, type: 'any' },
        { name: 'responseData', comments: { summary: null }, type: 'any' },
        { name: 'responseError', comments: { summary: null }, type: 'any' },
      ],
    },
    {
      name: 'QorusRequest',
      comments: { summary: null },
      properties: [
        { name: 'defaultHeaders', comments: { summary: 'Default headers for the QorusRequest' }, type: 'reflection' },
      ],
    },
    {
      name: 'QorusOptions',
      comments: { summary: null },
      properties: [
        { name: 'constructorOptions', comments: { summary: null }, type: 'Properties[ ]' },
        { name: 'name', comments: { summary: null }, type: 'string' },
      ],
    },
    {
      name: 'QorusValidator',
      comments: { summary: 'Utility class to validate provider_options properties' },
      properties: [{ name: 'validate', comments: { summary: null }, type: 'reflection' }],
    },
  ],
  methodDocs: [
    [
      {
        ...
        data: {
          ...
          comments: { summary: 'Fixes the endpoint data', returnSummary: 'Fixed Endpoint config' },
          returnTypes: [{}],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          params: [
            { label: 'data', type: 'LoginParams & AddEndpoint', description: 'Endpoint data to be checked' },
            {
      ...
      },
      {
        ...
        data: {
          ...
          params: [{ label: 'version', type: 'number | string', description: null }],
          comments: { summary: null },
          returnTypes: [{}],
        },
      },
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'array of DataProviders records',
          },
          returnTypes: [{}],
        },
      },
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'responseData, providerData and errorData for the current provider',
          },
          returnTypes: [{}],
        },
      },
    ...
    [
      ...
      },
      {
        ...
        data: {
          ...
          params: [
            { label: 'type', type: 'DELETE | POST | PUT | GET', description: null },
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'Result of the post request',
          },
          returnTypes: [{ label: 'T' }, { label: 'undefined' }],
        },
      },
    ...
    [
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'Object with constructor options',
          },
          returnTypes: [{}],
        },
      },
      ...
      },
      {
        ...
        data: {
          async: false,
          name: 'parseChildren',
          label: 'parseChildren( children: any ): ProviderOption | undefined',
          params: [{ label: 'children', type: 'any', description: 'children for which options will be created' }],
          comments: {
            summary: 'A parser function to modify options object',
            returnSummary: 'Object with constructor options',
          },
          returnTypes: [{ label: 'ProviderOption' }, { label: 'undefined' }],
        },
      },
      {
        className: 'QorusOptions',
      ...
      },
      {
        ...
        data: {
          ...
          params: [],
          comments: {
            summary: 'A validator to verify if all the required values are provided',
  ...
  interfaceDocs: [
    {
      ...
      params: [
        {
          label: 'endpointId',
          description: 'Id for the endpoint provided by the user, unique for every endpoint',
          type: 'string',
        },
        { label: 'url', description: 'URL to your server for the provided endpoint', type: 'string' },
    ...
    },
    {
      ...
      comments: { summary: null },
      params: [
        { label: 'authToken', description: 'Auth token for the user provided endpoint', type: 'string' },
        {
          label: 'endpointId',
          description: 'Id for the endpoint provided by the user, unique for every endpoint',
          type: 'string',
    ...
    },
    {
      ...
      comments: { summary: null },
      params: [
        { label: 'pass', description: 'Password for the authentication to your server', type: 'string' },
        { label: 'user', description: 'Username for the authentication to your server', type: 'string' },
      ],
    },
    {
      name: 'WithQorusAuthToken',
      comments: { summary: null },
      params: [{ label: 'authToken', description: 'Auth token for the user provided endpoint', type: 'string' }],
    },
    {
    ...
    },
    {
      name: 'WithQorusURL',
      comments: { summary: null },
      params: [{ label: 'url', description: 'URL to your server for the provided endpoint', type: 'string' }],
    },
    {
      name: 'QorusRequestParams',
      comments: { summary: null },
      params: [
        { label: 'data', description: 'Data for the request', type: 'any' },
        { label: 'headers', description: 'Headers for the request', type: 'AxiosRequestHeaders' },
        { label: 'params', description: 'URL Parameters for the request', type: 'Record' },
        { label: 'path', description: 'Complete endpoint url for the request', type: 'string' },
      ],
    },
    {
      name: 'Properties',
      comments: { summary: null },
      params: [
        { label: 'jsTypes', description: '', type: 'string[ ]' },
        { label: 'name', description: '', type: 'string' },
        { label: 'required', description: '', type: 'boolean' },
        { label: 'types', description: '', type: 'string[ ]' },
        { label: 'value', description: '', type: 'null' },
      ],
    },
    {
      name: 'ProviderOption',
      ...
      params: [
        { label: 'name', description: '', type: 'string' },
        { label: 'providerOptions', description: '', type: 'Properties[ ]' },
      ],
    },
  ],
  typeAliasDocs: [{ name: 'Version', comments: { summary: '' }, type: ['1', '2', '3', '4', '5', '6', 'latest'] }],
};
