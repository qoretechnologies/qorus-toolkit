  ...
  classesDocs: [
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'providerData', comments: { summary: 'Data provider data with children object' }, type: 'any' },
        { name: 'responseData', comments: { summary: 'Get Request response data for a data provider' }, type: 'any' },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: 'providerOptions', comments: { summary: null }, type: 'Properties[ ]' },
      ],
    },
    {
      name: 'QorusValidator',
    ...
    [
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            summary: 'A parser function to modify options object',
            returnSummary: 'Object with provider options',
          },
