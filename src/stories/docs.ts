  ...
  classesDocs: [
    {
      ...
      comment: {
        description: 'Enables the user to authenticate with multiple user defined endpoints',
        blockTags: [
          { name: 'returns', text: 'QorusAuthenticator object with all the supporting operations' },
          { name: 'Category', text: 'QorusAuthenticator' },
        ],
      },
      properties: [
        {
          name: 'allApiPaths',
          comment: { description: 'All Api paths for the selected endpoint', blockTags: [] },
          type: { kind: 'reference', name: 'ApiPaths' },
        },
        { name: 'apiPathsAuthenticator', comment: { description: null, blockTags: [] }, type: { kind: 'reflection' } },
        {
          name: 'endpoints',
          comment: { description: null, blockTags: [] },
          type: {
            kind: 'array',
            name: { kind: 'reference', id: 19, name: 'Endpoint', packageName: null, typeArguments: [] },
          },
        },
        { name: 'noauth', comment: { description: null, blockTags: [] }, type: { kind: 'intrinsic', name: 'boolean' } },
        {
          name: 'selectedEndpoint',
          comment: { description: 'Selected endpoint from the endpoints array', blockTags: [] },
          type: { kind: 'union' },
        },
      ],
    },
      ...
      properties: [
        {
          name: 'context',
          comment: { description: null, blockTags: [] },
          type: { kind: 'reference', name: 'Context' },
        },
        {
          name: 'path',
          comment: { description: null, blockTags: [] },
          type: { kind: 'array', name: { kind: 'intrinsic', type: 'string' } },
        },
        {
          name: 'providerData',
          comment: { description: null, blockTags: [] },
          type: { kind: 'intrinsic', name: 'any' },
        },
        {
          name: 'responseData',
          comment: { description: null, blockTags: [] },
    ...
    },
    {
      ...
      properties: [
        {
          name: 'defaultHeaders',
          comment: { description: 'Default headers for the QorusRequest', blockTags: [] },
      ...
      properties: [
        {
          ...
          type: {
            kind: 'array',
            name: { kind: 'reference', id: 201, name: 'Properties', packageName: null, typeArguments: [] },
          },
        },
        { name: 'name', comment: { description: null, blockTags: [] }, type: { kind: 'intrinsic', name: 'string' } },
      ],
    },
    {
      name: 'QorusValidator',
      comment: { description: 'Utility class to validate provider_options properties', blockTags: [] },
      properties: [{ name: 'validate', comment: { description: null, blockTags: [] }, type: { kind: 'reflection' } }],
    },
  ],
  methodDocs: [
    [
      {
        ...
        data: {
          async: false,
          name: '#fixEndpointData',
          label: "#fixEndpointData(' 'data: AddEndpoint )",
          params: [{ label: 'data', type: 'AddEndpoint', description: 'AddEndpoint, data to be fixed' }],
          comments: { summary: 'Fixed the endpoint data', returnSummary: 'Fixed Endpoint config' },
          returnTypes: [{ label: '' }],
        },
      },
      {
          ...
          params: [
            {
              ...
              type: 'AddEndpoint',
              description:
                'AddEndpoint requires url and accepts optional user and pass parameters to initialize the endpoint and then authenticate the user',
            },
          ],
          comments: { summary: 'Add a new Qorus Endpoint to interact with the qorus api.', returnSummary: 'Endpoint' },
          returnTypes: [{ label: '' }],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          label: "getEndpointById(' 'id: string ): Endpoint | undefined",
          params: [{ label: 'id', type: 'string', description: 'ID of the endpoint ex: "rippy"' }],
          comments: {
            summary: 'A getter to get the endpoint if it exist in the Endpoints array',
            returnSummary:
              'Endpoint if the endpoint with the provided id exist in the endpoints array, undefined otherwise.',
          },
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            summary: 'A getter to get the api {@link Version} of a {@link Endpoint}',
            returnSummary:
      ...
      },
      {
        ...
        data: {
          ...
          returnTypes: [{ label: 'undefined' }, { label: 'string' }],
        },
      },
      {
        className: 'QorusAuthenticator',
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'Endpoint if the operation is successful, false otherwise.',
          },
          returnTypes: [{ label: 'undefined' }, { label: 'Endpoint' }],
        },
      },
      {
        className: 'QorusAuthenticator',
        data: {
          async: true,
          name: 'setEndpointUrl',
          label: "setEndpointUrl(' 'url: string,' 'id: string ): Promise< string | undefined >",
          params: [
            { label: 'url', type: 'string', description: 'Base url for the endpoint' },
            {
              label: 'id',
              type: 'string',
              description: 'Optional id parameter to change the url of a particular endpoint',
            },
          ],
          comments: {
        ...
        data: {
          ...
          params: [
            { label: 'version', type: 'Version', description: 'Version of the qorus api' },
            {
              label: 'endpointId',
              type: 'string',
              description: 'Optional id parameter to change the url of a particular endpoint from the endpoints array',
            },
          ],
          comments: {
            summary: 'A setter to set the Version of the Endpoint',
            returnSummary: 'Version of the endpoint if the operation is successful, undefined otherwise',
          },
          returnTypes: [{ label: 'undefined' }, { label: 'Version' }],
        },
      },
      {
        className: 'QorusAuthenticator',
        data: {
          ...
          label: "validateEndpointData(' 'data: intersection,' 'withCredentials: boolean )",
          params: [
            { label: 'data', type: 'intersection', description: '{@link AddEndpoint} to be checked' },
            {
          ...
          comments: {
            ...
            returnSummary: 'True if the the Endpoint data is valid, False otherwise',
          },
          returnTypes: [{ label: '' }],
        },
      },
      {
        ...
        data: {
          ...
          label: "validateLocalUserToken(' 'endpointId: string ): Promise< string | undefined >",
          ...
          returnTypes: [{ label: 'literal' }, { label: 'string' }],
        },
      },
      {
        className: 'QorusAuthenticator',
        data: {
          ...
          label: "validateVersion(' 'version: union )",
          params: [{ label: 'version', type: 'union', description: null }],
    ...
    [
      {
        ...
        data: {
          async: true,
          name: 'fetchWithContext',
          label: "fetchWithContext(' 'context: Context ): Promise< undefined >",
          params: [{ label: 'context', type: 'Context', description: null }],
          comments: { summary: null },
          returnTypes: [{ label: 'reference' }],
        },
      },
      {
        className: 'QorusDataProvider',
        data: {
          async: true,
          name: 'get',
          label: "get(' 'select: string,' 'providerOptions: any ): Promise< undefined >",
          params: [
            { label: 'select', type: 'string', description: 'next children to be selected' },
            { label: 'providerOptions', type: 'any', description: null },
          ],
          comments: { summary: 'Method to select the next children from the current provider for further operations' },
          returnTypes: [{ label: 'reference' }],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          async: true,
          name: 'getApi',
          label: 'getApi( ): Promise< undefined >',
          params: [],
          comments: {
            summary:
      ...
      },
      {
        ...
        data: {
          ...
          params: [],
          comments: { summary: 'A getter to get the context for the current provider\n\nReturns context string' },
          returnTypes: [{ label: '' }],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          async: true,
          name: 'getEvent',
          label: 'getEvent( ): Promise< undefined >',
          params: [],
          comments: {
            summary:
      ...
      },
      {
        ...
        data: {
          async: false,
          name: 'getFinalPath',
          label: "getFinalPath(' 'path: string )",
          params: [
            {
              label: 'path',
              type: { kind: 'intrinsic', type: 'string' },
              description: 'Optional path array to generate request path\n\nReturns request path string',
            },
          ],
          comments: { summary: 'A getter to get request path for the current provider' },
          returnTypes: [{ label: '' }],
        },
      },
      {
        ...
        data: {
          async: true,
          name: 'getMessage',
          label: 'getMessage( ): Promise< undefined >',
          params: [],
          comments: {
            summary:
          ...
          params: [
            {
              label: 'childrenName',
              type: 'string',
              description: 'name of the children provider\nReturns QorusOptions object',
            },
          ],
          comments: { summary: 'A getter to get options by name for a children provider' },
      ...
      },
      {
        ...
        data: {
          ...
          params: [],
          comments: { summary: 'A getter to the the stored path array for the current provider\n\nReturns path array' },
          returnTypes: [{ label: { kind: 'intrinsic', type: 'string' } }, { label: 'undefined' }],
        },
      },
      {
        className: 'QorusDataProvider',
        data: {
          async: true,
          name: 'getRecord',
          label: 'getRecord( ): Promise< undefined >',
          params: [],
          comments: {
            summary:
      ...
      },
      {
        ...
        data: {
          async: true,
          name: 'getType',
          label: 'getType( ): Promise< undefined >',
          params: [],
          comments: {
            summary:
      ...
      },
      {
        ...
        data: {
          async: false,
          name: 'setData',
          label: "setData(' 'responseData: any,' 'providerData: any )",
          params: [
            { label: 'responseData', type: 'any', description: null },
            { label: 'providerData', type: 'any', description: null },
          ],
          comments: { summary: null },
          returnTypes: [{ label: '' }],
        },
    ...
    [
      {
        ...
        data: {
          ...
          comments: {
            ...
            returnSummary: 'Promise with the result of the delete request',
          },
          returnTypes: [{ label: 'undefined' }, { label: 'T' }],
        },
      },
      {
        className: 'QorusRequest',
      ...
      },
      {
        ...
        data: {
          async: true,
          name: 'makeRequest',
          label: "makeRequest(' 'type: union,' 'props: QorusRequestParams,' 'endpoint: Endpoint ): Promise< any >",
          params: [
            { label: 'type', type: 'union', description: null },
            { label: 'props', type: 'QorusRequestParams', description: null },
            { label: 'endpoint', type: 'Endpoint', description: null },
          ],
          comments: { summary: null },
      ...
      },
      {
        ...
        data: {
          ...
          comments: {
            summary: 'Post request creator for the QorusToolkit',
            returnSummary: 'Promise with the result of the post request',
          },
          returnTypes: [{ label: 'undefined' }, { label: 'T' }],
        },
      },
      {
        ...
        data: {
          ...
          comments: {
            summary: 'Put request creator for the QorusToolkit',
            returnSummary: 'the promise with the result of the put request',
          },
          returnTypes: [{ label: 'undefined' }, { label: 'T' }],
        },
      },
    ...
    [
      {
        ...
        data: {
          async: false,
          name: 'convertToJsType',
          label: "convertToJsType(' 'type: string )",
          params: [{ label: 'type', type: 'string', description: 'type to be converted' }],
          comments: { summary: 'A private function to convert types to js types', returnSummary: 'converted type' },
          returnTypes: [{ label: '' }],
        },
      },
      {
        ...
        data: {
          async: false,
          name: 'createJsTypes',
          label: "createJsTypes(' 'types: string )",
          params: [{ label: 'types', type: { kind: 'intrinsic', type: 'string' }, description: null }],
          comments: {
            summary: 'A parser function to modify options object',
            returnSummary: 'object with constructor options {@link ConstructorOption}',
          },
          returnTypes: [{ label: '' }],
        },
      },
      {
        ...
        data: {
          async: false,
          name: 'get',
          label: "get(' 'propertyName: string ): Properties | undefined",
          params: [{ label: 'propertyName', type: 'string', description: 'name of the property' }],
          comments: {
            summary: '-getProperty-function A getter to get property object',
            returnSummary: 'property object',
          },
          returnTypes: [{ label: 'Properties' }, { label: 'undefined' }],
        },
      },
      {
        className: 'QorusOptions',
        data: {
          async: false,
          name: 'getAll',
          label: 'getAll( ): undefined | undefined',
          params: [],
          comments: {
            summary: '-getAll-function Get all values required for the provider',
            returnSummary: 'all values if required values exist, undefined otherwise',
          },
          returnTypes: [{ label: 'reflection' }, { label: 'undefined' }],
        },
      },
      {
        className: 'QorusOptions',
        data: {
          ...
          params: [{ label: 'propertyName', type: 'string', description: 'name of the property' }],
          comments: {
            summary: '-getJsType-function A getter to get js types for a property',
      ...
      },
      {
        ...
        data: {
          ...
          params: [{ label: 'propertyName', type: 'string', description: 'name of the property' }],
          comments: {
            summary: '-getTypeOptions-function A getter to get property type',
            returnSummary: 'types accepted by the property',
          },
          returnTypes: [{ label: { kind: 'intrinsic', type: 'string' } }, { label: 'undefined' }],
        },
      },
      {
        ...
        data: {
          async: false,
          name: 'parseChildren',
          label: "parseChildren(' 'children: any ): ConstructorOption | undefined",
          params: [{ label: 'children', type: 'any', description: 'children for which options will be created' }],
          comments: {
            summary: 'A parser function to modify options object',
            returnSummary: 'object with constructor options {@link ConstructorOption}',
          },
          returnTypes: [{ label: 'ConstructorOption' }, { label: 'undefined' }],
        },
      },
      {
        className: 'QorusOptions',
        data: {
          async: false,
          name: 'set',
          label: "set(' 'propertyName: string,' 'value: any ): Properties | undefined",
          params: [
            { label: 'propertyName', type: 'string', description: 'name of the property' },
            { label: 'value', type: 'any', description: null },
          ],
          comments: {
            summary: '-setOptions-function A setter to set property value',
            returnSummary: 'property object',
          },
          returnTypes: [{ label: 'Properties' }, { label: 'undefined' }],
        },
      },
      {
        ...
        data: {
          ...
          params: [],
          comments: {
            summary: '-validate-function A validator to verify if all the required values are provided',
            returnSummary: 'true if all the value exist, false otherwise',
          },
          returnTypes: [{ label: '' }],
        },
      },
      {
        ...
        data: {
          ...
          label: "validateProperty(' 'propertyName: string,' 'value: any )",
          params: [
            { label: 'propertyName', type: 'string', description: 'name of the property' },
            { label: 'value', type: 'any', description: null },
          ],
    ...
    [
      {
        ...
        data: {
          ...
          label:
            "getTypeFromValue(' 'value: any ): undefined | undefined | undefined | undefined | undefined | undefined | undefined | undefined | undefined",
      ...
      },
      {
        ...
        data: {
          async: false,
          name: 'nullType',
          label: "nullType(' 'type: string )",
          params: [{ label: 'type', type: 'string', description: null }],
          comments: { summary: null },
          returnTypes: [{ label: '' }],
        },
      },
