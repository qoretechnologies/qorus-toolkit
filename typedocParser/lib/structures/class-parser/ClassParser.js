...
class ClassParser extends Parser_1.Parser {
    ...
    static generateFromTypeDoc(reflection) {
        ...
        if (construct === undefined)
            throw new Error(`Expected Class (${types_1.ReflectionKind.Class}) with a constructor, but there was none`);
        ...
        return new ClassParser({
            ...
            construct: ClassConstructorParser_1.ClassConstructorParser.generateFromTypeDoc(construct, id),
            properties,
            methods
        });
    }
